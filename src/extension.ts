...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand('datavirt.create.envvar.secret', createEnvironmentVariableCommandForSecret));
	context.subscriptions.push(vscode.commands.registerCommand('datavirt.create.envvar.configmap', createEnvironmentVariableCommandForConfigMap));
